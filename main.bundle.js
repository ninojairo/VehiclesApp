...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_vehicles_service__ = __webpack_require__("./src/app/services/vehicles.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__components_vehicles_vehicles_component__["a" /* VehiclesComponent */],
            ],
            imports: [
...
/***/ "./src/app/components/vehicles/vehicles.component.css":
/***/ (function(module, exports) {
...
module.exports = "<h1>Vehicles</h1>\n<div class=\"row animated fadeIn fast\">\n    <div class=\"container main-container\">\n        <table class=\"table \">\n            <thead>\n                <tr class=\"table-inverse\">\n                    <th>#</th>\n                    <th>Marca</th>\n                    <th>Modelo</th>\n                    <th>Cilindraje</th>\n                    <th>Kilometraje</th>\n                    <th>Revision TCM</th>\n                    <th>Accion</th>\n\n                </tr>\n            </thead>\n            <tbody>\n                <tr *ngFor=\"let k of vehicles | keys; let i = index\">\n                    <th scope=\"row\">{{i+1}}</th>\n                    <td>{{vehicles[k].marca}}</td>\n                    <td>{{vehicles[k].modelo}}</td>\n                    <td>{{vehicles[k].cilindraje}}</td>\n                    <td>{{vehicles[k].kilometraje}}</td>\n                    <td>{{vehicles[k].revisionTCM}}</td>\n                    <td class=\"text-right w120\">\n                        <button type=\"button\" class=\"btn btn-warning\">Actualizar</button>\n                        <button type=\"button\" class=\"btn btn-danger\">Eliminar</button>\n                    </td>\n                </tr>\n                <div class=\"col-md-12\">\n                    <button type=\"button\" class=\"btn btn-primary\">Nuevo</button>\n                </div>\n\n\n            </tbody>\n        </table>\n    </div>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_vehicles_service__ = __webpack_require__("./src/app/services/vehicles.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VehiclesComponent = /** @class */ (function () {
    function VehiclesComponent(_vehiclesService) {
        var _this = this;
        this._vehiclesService = _vehiclesService;
        this._vehiclesService.getVehicles().subscribe(function (res) {
            console.log(res);
            _this.vehicles = res;
        });
    }
    ...
    VehiclesComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            styles: [__webpack_require__("./src/app/components/vehicles/vehicles.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_vehicles_service__["a" /* VehiclesService */]])
    ], VehiclesComponent);
...
var VehiclesService = /** @class */ (function () {
    function VehiclesService(_http) {
        this._http = _http;
        this.URLVehicles = "https://vehiclesapp-da823.firebaseio.com/Vehicles.json";
    }
    VehiclesService.prototype.getVehicles = function () {
        return this._http.get(this.URLVehicles).map(function (res) {
